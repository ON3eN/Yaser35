...
urlpatterns = [
    ...
    path('add/<int:product_id>/', views.add_to_cart, name='add_to_cart'),  # إضافة منتج (إعادة توجيه)
    path('ajax/add/<int:product_id>/', views.ajax_add_to_cart, name='ajax_add_to_cart'),  # ✅ Ajax إضافة بدون تغيير الصفحة
    ...
    path('apply-coupon/', views.apply_coupon, name='apply_coupon'),  # تطبيق كود الخصم
]
