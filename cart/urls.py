...
urlpatterns = [
    path('', views.cart_view, name='cart'),  # 🛒 عرض سلة التسوق
    path('add/<int:product_id>/', views.add_to_cart, name='add_to_cart'),  # ➕ إضافة منتج للسلة (عادي)
    ...
    path('clear/', views.clear_cart, name='clear_cart'),  # 🧺 تفريغ السلة بالكامل
    path('apply-coupon/', views.apply_coupon, name='apply_coupon'),  # 🎟️ تطبيق كود خصم
]
